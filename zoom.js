document.getElementById('maxi').addEventListener(
   ...
   nouveau.setAttribute('style','z-index:899;position:absolute;top:0;left:0;text-align:center;border:1px solid grey;width:99%;height:99%;font-size:5em;background-color:rgba(255,255,255,0.8);');
